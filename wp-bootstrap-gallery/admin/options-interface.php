 ...
 */
function wpb_optionsframework_fields() {
        ...
        switch ($value['type']) {
            ...
            case 'donate':
                $output .= '<div class="section"><h4 class="heading">' . $value['name'] . '</h4>
                    ...
                    <img src="https://www.paypal.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" alt="Thank you for your donation!!!">
                    </a></div>';
                break;
            ...
            // Uploader
            case "upload":
                $output .= wpb_optionsframework_medialibrary_uploader($value['id'], $val, null); // New AJAX Uploader using Media Library	
                break;
            ...
            case 'typography':
                ...
                $faces = wpb_of_recognized_font_faces();
                ...
                /* Font Style */
                $styles = wpb_of_recognized_font_styles();
            ...
            case 'background':
                ...
                $output .= wpb_optionsframework_medialibrary_uploader($value['id'], $background['image'], null, '', 0, 'image');
                ...
                $repeats = wpb_of_recognized_background_repeat();
                ...
                $positions = wpb_of_recognized_background_position();
                ...
                $attachments = wpb_of_recognized_background_attachment();
            ...
            case "info":
                ...
                if ($value['desc']) {
                    $output .= apply_filters('wpb_of_sanitize_info', $value['desc']) . "\n";
                }
